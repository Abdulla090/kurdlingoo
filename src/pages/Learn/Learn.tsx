...
import {
    Star, BookOpen, Trophy, Flame, Zap,
        ...
        <div className="learn-page">
            ...
            <div className="main-content">
                ...
                {units.map((unit, unitIndex) => {
                    const gradients = [
                        'linear-gradient(135deg, #58cc02 0%, #23ac00 100%)', // Unit 1: Green
                        'linear-gradient(135deg, #1cb0f6 0%, #0c8fd6 100%)', // Unit 2: Blue
                        'linear-gradient(135deg, #ff4b4b 0%, #d33131 100%)', // Unit 3: Red
                        'linear-gradient(135deg, #ce82ff 0%, #a560ff 100%)'  // Unit 4: Purple
                    ];
