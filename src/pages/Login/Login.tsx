...
const Login: React.FC = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (error) {
            setError(isSignUp ? 'هەڵەیەک ڕوویدا لە کاتی دروستکردنی هەژمار. نموونە: تێپەڕەوشە زۆر کورتە.' : 'هەڵەیەک ڕوویدا لە کاتی چوونەژوورەوە، تکایە دڵنیابە لە زانیارییەکانت यان هێڵی ئینتەرنێتەکەت.');
            setLoading(false);
            return;
        }

        if (data && data.user) {
            await loadUserProgressFromDb(data.user.id);
            navigate('/learn');
        }
    };
                ...
                <div className="login-form-side">
                    <div className="login-form-inner">
                        ...
                        <div className="login-welcome">
                            <h3 className="login-welcome-title">{isSignUp ? 'هەژمارێکی نوێ دروستبکە' : 'بەخێربێیتەوە!'}</h3>
                            <p className="login-welcome-desc">{isSignUp ? 'بەشداری بکە بۆ دەستپێکردنی فێربوون.' : 'چوونەژوورەوە بۆ بەردەوامبوون لە فێربوون.'}</p>
                        </div>
                        ...
                        <form className="login-form" onSubmit={handleLogin}>
                            ...
                            <div className="login-form-group">
                                <div className="login-label-row">
                                    ...
                                    {!isSignUp && <a href="#" className="login-link">لەبیرت چووە؟</a>}
                                </div>
                                <div className="login-input-wrapper">
                            ...
                            >
                                {loading ? 'چاوەڕێ بکە...' : (isSignUp ? 'دروستکردنی هەژمار' : 'چوونەژوورەوە')}
                            </button>
                        </form>

                        <div className="login-footer">
                            <p>
                                {isSignUp ? 'پێشتر هەژمارت هەیە؟' : 'هەژمارت نییە؟'}
                                <a 
                                  href="#" 
                                ...
                                >
                                    {isSignUp ? 'چوونەژوورەوە' : 'ئێستا دروستی بکە'}
                                </a>
                            </p>
                        </div>
                    </div>
